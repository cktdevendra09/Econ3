    ...
    return (
        <div className="relative group shadow-md  rounded-md overflow-hidden">
            ...
            <div class="px-4 py-3 w-72">
                ...
                <Link href={'p/asdsadss'} class="text-lg font-bold text-black truncate block capitalize">Product Name</Link>
                <div class="flex items-center">
                    <p class="text-lg font-semibold text-black cursor-auto my-3">$149</p>
                    <del>
                        <p class="text-sm text-gray-600 cursor-auto ml-2">$199</p>
                    </del>
                    <div class="ml-auto inline-block py-2 px-3 hover:bg-gray-200 rounded-full relative ">
