            ...
            <div className="inline-flex">
                <Link className="_o6689fn" href="/">
                    <div className="hidden md:block">
                        ...
                        <Image  className="rounded-md" src="/logos/6.png" alt="" width="90" height="32" layout="responsive"/>
                ...
                <div className="flex justify-end items-center relative">
                    ...
                    <div className="flex mr-4 items-center">
                        ...
                        <div className="block relative">
                            <Link href={'/cart'} className="inline-block py-2 px-3 hover:bg-gray-200 rounded-full relative ">
                    ...
                    <div className="block">
                        <div className="inline relative">
                            <Link href={'/account'} className="inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
                                <div className="pl-1">
                                    <svg
                                        viewBox="0 0 32 32"
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="block flex-grow-0 flex-shrink-0 h-10 w-12 pl-5">
                                    <svg
                                        ...
                                        role="presentation"
                                        focusable="false"
                                        style={{ display: 'block', fill: 'currentcolor', height: '100%', width: '100%' }}
                                    >
