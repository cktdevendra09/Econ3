...
const ForgetPasswordUI = () => {
    return (
        <form action="" className="mt-6">            
            ...
            <Link href={'/otp-varification'} className="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5 bg-black border-none text-white text-sm shadow-sm">
                OTP Varification
            </Link>
        </form>
    )
