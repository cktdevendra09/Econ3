...
const Details = () => {
    return (
        ...
        <div className="md:px-20 2xl:px-20 2xl:container 2xl:mx-auto mt-4">
                    ...
                    <div className="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
                        ...
                        <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                            ...
                            <div className="flex w-full justify-center items-center md:justify-start md:items-start mt-5">
                                <button className="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5 bg-black border-none text-white text-sm shadow-sm">Cancle</button>
                            </div>
                        </div>
                    </div>
                </div>
