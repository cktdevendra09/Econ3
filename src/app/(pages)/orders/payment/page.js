...
const Payment = () => {
    return (
        <section className="body-font h-full bg-gray-100 pt-10 text-gray-600">
            <div className="container mx-auto  flex max-w-3xl flex-wrap justify-center rounded-lg bg-white px-5 py-24">
                <div className="flex-wrap md:flex">
                    <div className="mx-auto">
                        ...
                        <div>
                            <h1 className="font-laonoto mt-4 text-center text-xl font-bold">ໂອນດ້ວຍເລກບັນຊີ</h1>
                                ...
                                <div className="flex w-full items-center justify-center">
                                    <label className="flex h-14 w-full cursor-pointer flex-col border-4 border-dashed border-gray-200 hover:border-gray-300 hover:bg-gray-100">
                                        <div className="mt-4 flex items-center justify-center space-x-1">
                                            ...
                                            <p className="font-laonoto text-sm tracking-wider text-gray-400 group-hover:text-gray-600">ອັບໂຫຼດຮູບບິນ</p>
                                        </div>
                        ...
                        <button className="mx-auto block rounded-md border bg-blue-500 px-6 py-2 text-white outline-none">ສົ່ງຫຼັກຖານການໂອນ</button>
                    </div>
                    <div className="mt-8 max-w-sm md:mt-0 md:ml-10 md:w-2/3">
                        ...
                        <div className="relative flex pb-12">
                            ...
                            <div className="flex-grow pl-4">
                                ...
                                <p className="font-laonoto leading-relaxed">ແຈ້ງຫຼັກຖານການຊຳລະເງິນດ້ວຍ <b>ຮູບໃບບິນ</b> ຫຼື <b>ຮູບສະລິບການໂອນ</b>.</p>
                            </div>
                        </div>
                        <div className="relative flex pb-12">
                            <div className="relative z-10 inline-flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-blue-500 text-white">
                            ...
                            <div className="flex-grow pl-4">
                                ...
                                <p className="font-laonoto leading-relaxed">
                                    ສຳເລັດການໂອນ ກະລຸນາລໍຖ້າພະນັກງານກວດສອບ ທ່ານສາມາດກວດສອບສະຖານະການຊຳລະສຳເລັດໄດ້ ໄປທີ່ໜ້າ <span> <b>Payments</b></span
                                    >.
                                </p>
                            </div>
                        </div>
